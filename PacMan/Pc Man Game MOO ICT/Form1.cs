...
namespace Pc_Man_Game_MOO_ICT
{
    public partial class Form1 : Form
    {
        ...
        private void mainGameTimer(object sender, EventArgs e)
        {
            ...
            if (pinkGhost.Bounds.IntersectsWith(pictureBox1.Bounds) || pinkGhost.Bounds.IntersectsWith(pictureBox2.Bounds) || pinkGhost.Bounds.IntersectsWith(pictureBox3.Bounds) || pinkGhost.Bounds.IntersectsWith(pictureBox4.Bounds))
            {
                pinkGhostY = -pinkGhostY;
            }
            if (pinkGhost.Bounds.IntersectsWith(pictureBox1.Bounds) || pinkGhost.Bounds.IntersectsWith(pictureBox2.Bounds))
            {
                pinkGhostX = -pinkGhostX;
            }
        ...
        private void gameOver(string message)
        {
            ...
            txtScore.Text = "Score: " + score + Environment.NewLine + message;
             this.Close();
            MessageBox.Show("Well done!" + Environment.NewLine + "You have colected " + score + " Coins.");
